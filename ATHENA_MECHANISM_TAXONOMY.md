...
| T-05 | PPP/Unif en \(\mathbb{R}^d\) + hard-core métrico | puntos en caja | distancia euclídea, \(\varepsilon\) | ordinal como regla; Athena; T-01/03/04 raw | etiquetas aceptadas | — | — | — | — | **REFERENCE_COMPLETE** (`discovery/T05_STATUS.md`) |
